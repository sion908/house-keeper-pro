...
from crud.user import get_by_lineUserID_with_card
from models import RallyConfiguration, User

@pytest.mark.asyncio()
class TestCardService():

    def test_init_card_service(self):
...
class TestShowCards():
    ...
    async def test_main(
        ...
        mock_rep_mess = mocker.patch("services.card.line_bot_api.reply_message", return_value="")
