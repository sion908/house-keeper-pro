...
Revision ID: 4a7af3836d80
Revises:
Create Date: 2024-03-24 08:06:29.474180+09:00
...
def upgrade() -> None:
    ...
    sa.Column('id', mysql.SMALLINT(unsigned=True), nullable=False),
    sa.Column('start', mysql.DATETIME(timezone=True), nullable=False),
    sa.Column('end', mysql.DATETIME(timezone=True), nullable=False),
    ...
    op.create_table('formclassfloor',
    sa.Column('id', mysql.TINYINT(unsigned=True), nullable=False),
    sa.Column('title', mysql.VARCHAR(length=255), nullable=True, comment='タイトル'),
    sa.Column('description', mysql.TEXT(), nullable=True, comment='説明'),
    sa.Column('order', mysql.TINYINT(unsigned=True), nullable=False, comment='表示順'),
    ...
    op.create_table('formclassarea',
    sa.Column('id', mysql.TINYINT(unsigned=True), nullable=False),
    sa.Column('title', mysql.VARCHAR(length=255), nullable=True, comment='タイトル'),
    sa.Column('description', mysql.TEXT(), nullable=True, comment='説明'),
    sa.Column('order', mysql.TINYINT(unsigned=True), nullable=False, comment='表示順'),
    sa.Column('form_class_floor_id', mysql.TINYINT(unsigned=True), nullable=True),
    sa.Column('updated_at', sa.DateTime(), nullable=False, comment='更新日時'),
    sa.Column('created_at', sa.DateTime(), nullable=False, comment='作成日時'),
    sa.ForeignKeyConstraint(['form_class_floor_id'], ['formclassfloor.id'], ),
    sa.PrimaryKeyConstraint('id'),
    comment='formの中項目, エリア',
    mysql_charset='utf8mb4',
    mysql_collate='utf8mb4_bin'
    )
    ...
    sa.Column('title', mysql.VARCHAR(length=255), nullable=True, comment='タイトル'),
    sa.Column('description', mysql.TEXT(), nullable=True, comment='説明'),
    sa.Column('order', mysql.TINYINT(unsigned=True), nullable=False, comment='formの順番'),
    sa.Column('type', ChoiceType(choices=StubType, impl=mysql.TINYINT()), nullable=False, comment='formの種類'),
    sa.Column('form_class_area_id', mysql.TINYINT(unsigned=True), nullable=True),
    sa.Column('updated_at', sa.DateTime(), nullable=False, comment='更新日時'),
    sa.Column('created_at', sa.DateTime(), nullable=False, comment='作成日時'),
    sa.ForeignKeyConstraint(['form_class_area_id'], ['formclassarea.id'], ),
    sa.PrimaryKeyConstraint('id'),
    comment='画像用のフォームの一部',
    mysql_charset='utf8mb4',
    mysql_collate='utf8mb4_bin'
    ...
    sa.Column('id', mysql.SMALLINT(unsigned=True), nullable=False),
    sa.Column('key_be', mysql.VARCHAR(length=128), nullable=False),
    sa.Column('key_af', mysql.VARCHAR(length=128), nullable=False),
    sa.Column('form_stub_id', mysql.SMALLINT(unsigned=True), nullable=False),
...
def downgrade() -> None:
    ...
    op.drop_table('formclassarea')
    op.drop_table('formclassfloor')
